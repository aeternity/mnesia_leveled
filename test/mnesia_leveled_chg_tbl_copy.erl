...
-module(mnesia_leveled_chg_tbl_copy).
...
run() ->
    run([led,disc_copies,led,ram_copies,disc_only_copies,led]).
...
copies() ->
    [led,ram_copies,disc_copies,disc_only_copies].
...
start_mnesia() -> mnesia_leveled_tlib:start_mnesia(reset).
